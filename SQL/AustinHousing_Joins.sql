...
SELECT r.zpid, r."latestPrice", r."numOfBathrooms", r."livingAreaSqFt", r."numOfBedrooms", r."avgSchoolRating", r."numOfStories", r."MedianStudentsPerTeacher", r."numOfHighSchools", r."longitude", r."numOfPrimarySchools", r."avgSchoolDistance", r."latitude", r."lotSizeSqFt", r."numOfPhotos", r."numPriceChanges", r."zipcode", r."yearBuilt", r."propertyTaxRate", r."latest_saledate", r."latest_salemonth", r."latest_saleyear", z."averagePrice"
